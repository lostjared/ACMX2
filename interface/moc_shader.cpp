...
QT_INIT_METAOBJECT const QMetaObject ShaderDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ShaderDialog.data,
    qt_meta_data_ShaderDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ShaderDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShaderDialog.stringdata0))
